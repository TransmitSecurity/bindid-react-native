...
declare const XmBindIdButtonClass = "xm-bind-id-button";
declare const XmBindIdButtonOnFailureCallback = "data-xm-bind-id-on-failure";
declare const XmBindIdButtonOnSuccessCallback = "data-xm-bind-id-on-success";
/**
 List of icons supported by Approval request
 */
declare enum XmBindIdApprovalIcons {
 ...
 */
declare enum XmBindIdErrorCode {
 ...
 */
declare enum XmBindIdApiCompatibilityLevel {
 ...
 */
declare enum XmBindIdBoundToType {
 ...
 */
declare enum XmBindIdScopeType {
 ...
 */
declare enum XmRequiredVerifications {
 ...
 */
declare enum XmBindIdServerEnvironmentMode {
 ...
 */
declare interface XmBindIdServerEnvironment { 
 ...
 */
declare interface XmBindIdConfig { 
 ...
 */
declare interface XmBindIdOtherLoginOptions { 
 ...
 */
declare interface XmBindIdLoginHint { 
 ...
 */
declare interface XmBindIdBoundTo { 
 ...
 */
declare interface XmBindIdRequest { 
 ...
 */
declare interface XmBindIdAuthenticationRequest extends XmBindIdRequest { 
...
/**
 ...
 Configuration for a BindID authentication request.
 */
declare interface XmBindIdBoundUserAuthenticationRequest extends XmBindIdRequest { 
 ...
 */
declare interface XmBindIdTransactionSigningData { 
...
declare interface XmBindIdTransactionSigningRequest extends XmBindIdRequest { 
...
declare enum XmBindIdTokenType {
 ...
 */
declare interface XmBindIdExchangeTokenResponse { 
 ...
 */
declare interface XmBindIdResponse { 
...
declare interface XmBindIdExchangeTokenRequest { 
...
declare interface XmBindIdApprovalBaseAttribute { 
...
declare interface XmBindIdApprovalAttribute extends XmBindIdApprovalBaseAttribute { 
 ...
 */
declare interface XmBindIdApprovalSigningDisplayData { 
...
/**
 ...
 bindid_approval.
 */
declare interface XmBindIdApprovalSigningData { 
 ...
 */
declare interface XmBindIdApprovalSigningRequest extends XmBindIdRequest { 
